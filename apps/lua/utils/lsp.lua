...
M.on_attach = function(event)
	...
	keymap("n", "<leader>oi", organize_imports, opts)
...
vim.api.nvim_create_autocmd("BufWritePre", {
	group = augroup,
	pattern = "*.rs", -- Uniquement pour Rust
	callback = function()
		-- 1. On organise les imports (ajoute les manquants, retire les inutiles)
		organize_imports()
		-- 2. On formate le code proprement
